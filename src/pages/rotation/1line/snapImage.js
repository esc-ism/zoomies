...
const svg = getDiagram(
	...
	[-radii.x * 0.8 - strokeDiameter, -radii.y - strokeDiameter],
	[radii.x * 1.15 + strokeDiameter, -radii.y * 0.2 - strokeDiameter],
);

const points = [
	[[0, 0], [-radii.x * 0.8 - strokeDiameter, -radii.y - strokeDiameter], 0],
	[[radii.x * 0.3, -radii.y * 0.05], [radii.x * 1.15 + strokeDiameter, -radii.y * 0.2 - strokeDiameter], 1],
];
...
const crosshairWidth = strokeDiameter * 2;
...
crosshairG.setAttribute('stroke-width', `${strokeDiameter / 2}`);
...
svg.append(
	...
	...groups,
	crosshairG,
	getText('A', [0, 0], strokeDiameter, -0.2, 1),
	getText('B', points[0][1], strokeDiameter, -0.8, -1),
	getText('C', points[1][0], strokeDiameter, -1.2, 0),
	getText('D', points[1][1], strokeDiameter, -0.2, -1),
	getText('E', [-11, -6.5], strokeDiameter),
	getText('F', [16, 0], strokeDiameter),
	getText('(x, y)', snap, strokeDiameter, -1.8, -1.4),
);
